...
export const proposals: Proposal[] = [
    ...
    },
    {
        ...
        origin: "team",
        title: {
            es: "Terminar la aplicación para Android",
            en: "Complete the Android app",
            fr: "Terminer l'application Android",
            it: "Completare l'app per Android",
            pl: "Dokonczenie aplikacji na Androida",
        },
        description: {
            es: "Completar el desarrollo y dejar lista la experiencia móvil de Vallax en Android.",
            en: "Finish development and get the Vallax mobile experience ready for Android.",
            fr: "Finaliser le développement de l'expérience mobile Vallax sur Android.",
            it: "Completare lo sviluppo dell'esperienza mobile Vallax su Android.",
            pl: "Zakonczenie prac nad mobilna wersja Vallax na Androida.",
        },
    },
    {
        id: "ai-filter",
